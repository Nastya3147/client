    ...
    <footer class="b-footer">
      <b-row align-v="center" align-h="center">
        ...
        <b-col md="8" class="text-center">
             <button @click="adds=true" class="block">+</button>
...
ap:false,
      ...
      series: [{
        ...
        data: [],
       // Establecer el ancho individual del histograma
  ...
  computed: {
    Colum:function () {
      return  20 + (60 / (1 + 30*Math.exp(-this.graf.length /3)));
    },
            ...
            // console.log(this.graf[j])
              ...
              if(this.graf[j]===objs[i].date.split(' ')[0]) {
                ...
                console.log('99999999999')
                     ...
                     this.par[j]=objs[i].title.toFixed(1)
                   }
...
this.alg=''
    ...
    // async Colors(){
    //   var c='background-color:black'
    //   return  c
    // },
    async Starts(){

      // for(var date in this.dateList){
      //   if(date.date===this.tasks.date){
